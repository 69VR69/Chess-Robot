...
img = cv2.imread(r'C:\Users\ddbtn\PycharmProjects\chess_board_detection_refactor\test\top_down_dataset\chessboard_small_cropped.jpg')
...
path = r'C:\Users\ddbtn\PycharmProjects\chess_board_detection_refactor\test\squares'
...
for x in np.arange(8):
    for y in np.arange(8):
        ...
        cv2.imwrite(r'C:\Users\ddbtn\PycharmProjects\chess_board_detection_refactor\test\squares\test1_cropped_' +
...
# remove file from squares directory
